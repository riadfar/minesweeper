  ...
  return [
    ...
    IconButton(
      onPressed: () {
        ...
        gameSave.gameList.games.last.game.field.printField(revealMines: true);
      },
        ...
        return state.status == SaveLoadStatus.loading
            ...
            : IconButton(
              onPressed: () {
                ...
                state.games.first.gameList.games.first.game.field.printField(
                  revealMines: true,
                );
                state.games.first.gameList.games.last.game.field.printField(
                  revealMines: true,
                );
              },
